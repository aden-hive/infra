...
// postTransitionRetryWindow bounds how long after the peer flips uploaded=true
// a base ErrObjectNotExist is treated as a recoverable transition signal
// rather than a permanent failure. Covers GCS post-finalize visibility lag.
...
type peerSeekable struct {
	...
	// transitionAt is the unix-nano timestamp of the first transition emission,
	// used to bound the retry-on-404 window against the live base.
